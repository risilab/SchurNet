...
class Net_Andrew_batched_no_autobahn(torch.nn.Module):
    ...
    def forward(self, data) -> torch.Tensor:
        ...
        # edge_rep = p.batched_ptensors0b.from_matrix(self.edge_embedding(data.edge_attr.flatten()),edges)
...
if __name__ == "__main__":
    ...
    model = Net_Andrew_batched_no_autobahn(embedding_dim=2,hidden_dim=4,dense_dim=4,num_layers=4,dropout_rate=0.2,readout=global_add_pool).to(device)
