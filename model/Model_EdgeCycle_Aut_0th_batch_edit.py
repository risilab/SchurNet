...
class Edge_cycle(torch.nn.Module):
    def __init__(self, rep_dim, num_channels, cycle_sizes) -> None:
        ...
        self.cycle_mlp_2 = get_mlp(3 * rep_dim,rep_dim * _inner_mlp_mult,rep_dim,2)
        self.cycle_mlp = get_mlp((num_channels + 2) * rep_dim,rep_dim * _inner_mlp_mult,rep_dim,3)
    ...
    def forward(self,edge_rep,cycles_rep,G,data):
        ...
        cycles_new = [self.cycle_mlp_2(cycle_new.torch()) for cycle_new in cycles_new] #nc * 3 -> nc
